...
| [ Michael Miranda 2] | Desarrollador | `@maicol1210` |
...
* **Comunicación Oficial y Archivos:** [michael.miranda@soy.sena.edu.co]
...
* **Reuniones de Sincronización (Daily Stand-up):** Nos reuniremos los días [lunes a viernes] a las [1:30pm ] de forma [Presencial/Virtual].
...
* **Regla del Bloqueo (Timeboxing):** Si un desarrollador lleva más de [Ej:15 minutos] atascado en el mismo error, **debe** levantar la mano y pedir ayuda al equipo. No se permite perder días enteros en silencio.
...
1. **Ausencias:** Si alguien no puede trabajar por fuerza mayor, debe avisar por el canal oficial con al menos [Ej: 6 horas] de anticipación para reasignar sus tareas.
